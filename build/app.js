...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_lab__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_cubehelix__ = __webpack_require__(22);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_0__src_categorical_Accent__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__src_categorical_Pastel1__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_33__src_sequential_single_Reds__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__d3AdjacencyMatrixLayout__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__d3StratumLayout__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__d3LinearLayout__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_scale_chromatic__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_tip__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_d3_tip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_d3_tip__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_underscore__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["a"] = (function (data) {
            const svg = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]("svg"),
              size = canvasSize('svg'),
              width = size[0],
              height = size[1];
            ...
            console.log(__WEBPACK_IMPORTED_MODULE_1__d3AdjacencyMatrixLayout__["a" /* default */]);

            const adjacencyMatrix = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__d3AdjacencyMatrixLayout__["a" /* default */])();
            ...
            const someColors = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleSequential"](__WEBPACK_IMPORTED_MODULE_4_d3_scale_chromatic__["b" /* interpolateReds */]).domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["max"](data.links, (d) => d.weight)]);
            ...
            const tooltip = __WEBPACK_IMPORTED_MODULE_5_d3_tip__().attr('class', 'd3-tip').offset([-10, 0]);

            svg.call(tooltip);


            const matrixMaxX = __WEBPACK_IMPORTED_MODULE_0_d3__["max"](matrixData, d => d.x);
            const matrixMaxY = __WEBPACK_IMPORTED_MODULE_0_d3__["max"](matrixData, d => d.y);
              ...
              .append('g')
                ...
                .append('rect')
                  ...
                  .on("mouseout", function(p) {
                    const regex = /row-(\S*)/g;
                    const currentGroupID = regex.exec(__WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr('class'))[1];
                    __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.link[id^="${currentGroupID}-"]`)
                      .style('stroke-opacity', .03);
                    unhighlight();
                  })
                  .on("click", function(p) {
                    const data = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).data()[0];
            ...
            __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('#adjacencyG')
            ...
            const stratum = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__d3StratumLayout__["a" /* default */])()
            ...
            let questionnaireStratum = data.nodes.map(node => {
              return node.concepts.map(concept => {
                const index = __WEBPACK_IMPORTED_MODULE_6_underscore__["findIndex"](stratumData.nodes, d => d.name == concept);
                return { 
                  index : index,
           ...
           function mouseover(p) {
              ...
              __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]("rect")
                  ...
                  .style('fill-opacity', (d, i) => { 
                    ...
                    .each(d => {
                      ...
                      __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`[id^=line-${colQuestionnaireIndex}-]`)
                        .style('stroke-opacity', 1)
                        .each(function(d) {
                          const targetGroupID = 'i' + __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr('id').split('-')[2];
                          __WEBPACK_IMPORTED_MODULE_0_d3__["select"](`#${targetGroupID}`).style('fill-opacity', 1);
                      });

                      data.nodes[rowQuestionnaireIndex].concepts.forEach(concept => {
                        __WEBPACK_IMPORTED_MODULE_0_d3__["select"](`circle[id^=${concept}-]`)
                          .style("opacity", 1);
                      })
                  });
            ...
            function unhighlight() {
                ...
                __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]("rect")
                  ...
                  .style('fill-opacity', 0.5);
                __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`[id^=line]`)
                        .style('stroke-opacity', .1);
                __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]("[id^=i]")
                        .style('fill-opacity', .3);
                __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](".concept-circle")
                          .style("opacity", .3);
            };
            ...
            const color = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleOrdinal"](__WEBPACK_IMPORTED_MODULE_4_d3_scale_chromatic__["c" /* schemeAccent */]);
            const termsRadiusScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
            ...
            function highlightSquaresIncludingConcepts(concepts) {
              const selection = svg.select('#adjacencyG').selectAll('rect').filter(function(d, i){
                              ...
                              if (d.weight > 0) {
                                if (!d.isMirror)
                                  return __WEBPACK_IMPORTED_MODULE_6_underscore__["intersection"](d.source.concepts, concepts).length > 0;
                                else
                                  return __WEBPACK_IMPORTED_MODULE_6_underscore__["intersection"](d.target.concepts, concepts).length > 0;
                              } else return 0;
                            }).transition()
                                .duration(100)
            ...
            function unhighlightAllSquares() {
              __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]("rect").style('fill-opacity', 0.5);
            }

            const conceptsContext = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('svg')
                .append('g')
            ...
            const groupsCount = __WEBPACK_IMPORTED_MODULE_6_underscore__["groupBy"](stratumData.nodes, "level");
                    ...
                    .enter()
                      .append("circle")
                          ...
                          .on("mouseover", function(c) {
                            tooltip.html(c.name);
                            tooltip.show();
                            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).style('opacity', 1);
                            console.log(c);
                            highlightSquaresIncludingConcepts([c.name]);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](`#group-${c.level}`)
                              .style('fill-opacity', function (d) {
                                  const previous = parseFloat(__WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).style('fill-opacity'));
                                  return parseFloat(previous) + 1 / groupsCount[c.level].length;
                              });
                            
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.link[id$="-${c.level}-${c.index}"]`)
                              .style('stroke-opacity', 1.0);
                          })
                          .on("mouseout", function(c) {
                            tooltip.hide();
                            // d3.selectAll("*").interrupt();
                            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).style("opacity", .3);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.link[id$="-${c.level}-${c.index}"]`)
                              .style('stroke-opacity', .03);
                            unhighlightAllSquares();
                          })
                          .on("click", function(d) {
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"]("*").interrupt();
            ...
            conceptsContext
                      ...
                      .enter()
                        ...
                        .on('mouseover', function (c) {
                            ...
                            tooltip.show();
                            console.log(c);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).style('fill-opacity', 1);
                            const concepts = [];
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`circle[id$="-${c.group}"]`)
                              .style("opacity", 1)
                              .each(d => {concepts.push(d.name);});
                            highlightSquaresIncludingConcepts(concepts);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.link[id*="-${c.group}-"]`)
                              .style('stroke-opacity', 1.0);
                        ...
                        .on('mouseout', function (c) {
                            tooltip.hide();
                            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).style('fill-opacity', .5);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`circle[id$="-${c.group}"]`)
                              .style("opacity", .3);
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.link[id*="-${c.group}-"]`)
                              .style('stroke-opacity', .03);
            ...
            const linear  = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__d3LinearLayout__["a" /* default */])()
                              .data(data.coincident_groups)
                              .sizeLength(mside);
            const linearData = linear();

            
            __WEBPACK_IMPORTED_MODULE_0_d3__["extent"](linearData, node => node.occurrences);
            const radiusScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
                                    .domain(__WEBPACK_IMPORTED_MODULE_0_d3__["extent"](linearData, node => node.occurrences))
                                    .range([5,8]);
                  ...
                  .append('g')
                    .append('circle')
                      ...
                      .on("mouseover", function (p) {
                        ...
                        const thisSelect = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this);
                        thisSelect.style('fill-opacity', 1);
                        const groupID = thisSelect.attr('id').replace('i','');
                        __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.association-line[id$="-${groupID}"]`)
                          .style('stroke-opacity', 1)
                          .each(function(d) {
                            const questionnaireIndex = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this).attr('id').split('-')[1];
                            const questionnaireID = data.nodes[questionnaireIndex].id;
                            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`[class$=column-${questionnaireID}]`)
                              .style('fill-opacity', 1);
                          });
                        })
            ...
            const generator = __WEBPACK_IMPORTED_MODULE_0_d3__["line"]().curve(__WEBPACK_IMPORTED_MODULE_0_d3__["curveBundle"].beta(0.2));

            __WEBPACK_IMPORTED_MODULE_0_d3__["selectAll"](`.column-${data.nodes[data.nodes.length - 1].id}`)
              .filter(d => d.isMirror)
              .each(function (d, i) {
                  const thisItem = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this);
                  ...
                  questionnaireStratum[i].forEach(destObject => {
                      ...
                      const targetNode = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('#conceptsA').select(`rect#group-${destObject.level}`);
                      const targetX = 0;
            ...
            function drawLinks() {
              ...
              const matrixG = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('#adjacencyG')
                          matrixG 
                              .selectAll(`[id^=${lastID}]`)
                              .filter(d => !d.isMirror)
                              .each(function(d, i){
                                ...
                                Object.keys(targetGroups).forEach(targetGroupID => {
                                  ...
                                  const targetNode = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('#conceptsG').select('#i'+targetGroupID);
...
const canvasSize = (targetElement) => {
                var height = parseFloat(__WEBPACK_IMPORTED_MODULE_0_d3__["select"](targetElement)
                .node().clientHeight);
                var width = parseFloat(__WEBPACK_IMPORTED_MODULE_0_d3__["select"](targetElement).node().clientWidth);
                return [width,height];
          };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_hsl__ = __webpack_require__(27);
/* unused harmony reexport interpolateHsl */
/* unused harmony reexport interpolateHslLong */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_lab__ = __webpack_require__(28);
/* unused harmony reexport interpolateLab */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_hcl__ = __webpack_require__(26);
/* unused harmony reexport interpolateHcl */
/* unused harmony reexport interpolateHclLong */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_cubehelix__ = __webpack_require__(25);
/* unused harmony reexport interpolateCubehelix */
/* unused harmony reexport interpolateCubehelixLong */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_quantize__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__decompose__ = __webpack_require__(31);
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  function matrix() {
    ...
    const matrix = [];
    const edgeHash = {};
    const xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
      .domain([0, nodes.length])
      .range([0, width]);

    const yScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]()
      .domain([0, nodes.length])
      .range([0, height]);
  ...
  matrix.xAxis = calledG => {
    const nameScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scalePoint"]()
      .domain(nodes.map(nodeID))
      .range([0, size[0]])
      .padding(1);

    const xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisTop"]()
      .scale(nameScale)
      .tickSize(4);
  ...
  matrix.yAxis = calledG => {
    ...
    const yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["axisLeft"]()
      .scale(nameScale)
      .tickSize(4);
...
/* harmony default export */ __webpack_exports__["a"] = (function() {
  ...
  function linear() {
    ...
    const xScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]().domain([0, numberOfGroups -1]).range([0, sizeLength]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_d3__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["a"] = (function() {
  ...
  function strata() {
    ...
    const gridXScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]().domain([0, maxColumns]).range([25, size[0]]);
    ...
    const gridYScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]().domain([0, row]).range([0, size[1]]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_d3__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_scale_chromatic__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chart__ = __webpack_require__(21);
...
ready(function() { 
    ...
    const titleColorScale = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleOrdinal"](__WEBPACK_IMPORTED_MODULE_1_d3_scale_chromatic__["a" /* schemePastel1 */]);
    __WEBPACK_IMPORTED_MODULE_0_d3__["select"](".title")
      .append("div")
        .attr('id', 'title-spans')
        .selectAll("span")
        .data(titleData)
	...
	select.addEventListener("change", function () {
		__WEBPACK_IMPORTED_MODULE_0_d3__["select"]("svg").selectAll("*").remove();
		__WEBPACK_IMPORTED_MODULE_0_d3__["json"](`./data/fragebogen${select.options[select.selectedIndex].value}-graph.json`, __WEBPACK_IMPORTED_MODULE_2__chart__["a" /* default */]);
	});
	__WEBPACK_IMPORTED_MODULE_0_d3__["json"](`./data/fragebogen11-graph.json`, __WEBPACK_IMPORTED_MODULE_2__chart__["a" /* default */]);
});
